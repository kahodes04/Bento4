...
extern "C" __attribute__((visibility("default"))) unsigned char* DecryptMP4Content(const unsigned char* inputData, size_t inputSize, size_t* outputSize) {
    *outputSize = inputSize;  // Set the output size to the input size
    return (unsigned char*)inputData;  // Return the same pointer
}
/*----------------------------------------------------------------------
|   main
+---------------------------------------------------------------------*/
